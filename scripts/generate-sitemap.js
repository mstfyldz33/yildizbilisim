...
const staticPages = [
  ...
  { url: '/services/silifke', priority: '0.9', changefreq: 'weekly' },
  { url: '/services/tasucu', priority: '0.8', changefreq: 'weekly' },
  { url: '/services/aydincik', priority: '0.8', changefreq: 'weekly' },
  { url: '/services/anamur', priority: '0.8', changefreq: 'weekly' },
  { url: '/services/kizkalesi', priority: '0.8', changefreq: 'weekly' },
  { url: '/services/kurumsal', priority: '0.8', changefreq: 'weekly' },
  { url: '/services/acil-servis', priority: '0.8', changefreq: 'weekly' },
  { url: '/services/fiyatlar', priority: '0.8', changefreq: 'weekly' },
